...
Download the binary for your platform from the QuinSQL release page. Run the interactive setup wizard to configure your connection and create the QuinSQL data directory:
